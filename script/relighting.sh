...
# python relighting.py -co configs/nerf_syn --video --output "output/relighting/nerf_syn_ocean" -e "env_map/ocean_from_horn.jpg" --sample_num 384
...
python relighting.py -co configs/self_syn --video --output "output/relighting/self_syn" -e "env_map/000.exr" --sample_num 384